!function (e) {
    ...
    var d = function () {
        function e() {
            ...
            !function (e, t) {
                ...
                baseUrl: "", header: {}, method: "GET", dataType: "json", custom: {}, sslVerify: !0
            }), f(this, "interceptor", {
                request: function (e) {
        ...
        return d.prototype = g.constructor = p, p.constructor = d, d.displayName = u(p, i, "GeneratorFunction"), e.isGeneratorFunction = function (e) {
            ...
            constructor: j, reset: function (e) {
                ...
                return this.delegate = {
                    iterator: S(e), resultName: t, nextLoc: r
    ...
    var o = {versionCode: 10003, versionName: "1.0.3", appPlatrorm: "IN1"};
    t.appVersion = o;
    var a = o.versionName;
    ...
    t.httpHost = "https://data.202loan.com";
    var s, c = {
        CODE: "202", NAME: "202 Loan", LANG: "fr-FR", CCY: "\u20ac", AC: "+33", NDC: (s = Array(20), function (e) {
