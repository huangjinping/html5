$(function () {
    ...
    var  wechat=getWeiXinStatus();
    $(".remind").text(system+"=========="+wechat);
                ...
                if (data.code == 0) {
                    ...
                    if (system == 1 || system == 3) {
                        for (var i = 0; i < data.result.ios.length; i++) {
                            ...
                            html = html + '<p class="and lisA" href="' + data.result.ios[i].urlValue + '" >' + data.result.ios[i].name + '</p>';
                            html = html + ' </li>';
                        }
                    }
                    if (system == 2) {
                    ...
                    //             "id": idS
                    //         },
                    //         url: "https://hdfex.com/hd-merchant-web/mobile/order/readStatus",  // https://hdfex.com/hd-merchant-web/mobile/order/getContratUrlList
                    //         dataType: "json",
    ...
    $(".and").click(function () {
        ...
        if (typeof (hdMobile) != 'undefined') {
            hdMobile.openpdf($(this).attr('href'));
        }

        try {
            if (typeof (wx) != 'undefined') {
                $(".remind").text("openWechatPDF");

                wx.miniProgram.postMessage({data: 'foo'});
//        console.log(wx);
                return;

                console.log("=======>>>openWechatPDF>>>>>>>>>>");
...
/**
 * 获取微信类型0不是微信，1小程序，2，不是小程序
 * @returns {number}
 */

function getWeiXinStatus() {
